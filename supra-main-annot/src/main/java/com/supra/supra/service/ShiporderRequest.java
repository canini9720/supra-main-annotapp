...
@XmlRootElement(name = "shiporderRequest")
public class ShiporderRequest {

    @XmlElement(required = true)
    protected String orderperson;
    @XmlElement(required = true)
    protected ShiporderRequest.Shipto shipto;
    @XmlElement(required = true)
    protected List<ShiporderRequest.Item> item;
     ...
     * @return
     *     possible object is
     *     {@link ShiporderRequest.Shipto }
     *     
     */
    public ShiporderRequest.Shipto getShipto() {
        return shipto;
    }
     ...
     *     
     */
    public void setShipto(ShiporderRequest.Shipto value) {
        this.shipto = value;
    }
     ...
     * {@link ShiporderRequest.Item }
     * 
     * 
     */
    public List<ShiporderRequest.Item> getItem() {
        if (item == null) {
            item = new ArrayList<ShiporderRequest.Item>();
        }
        return this.item;
    }
	...
	public String toString() {
		return "ShiporderRequest [orderperson=" + orderperson + ", shipto=" + shipto + ", item=" + item + ", orderid="
				+ orderid + "]";
	}
